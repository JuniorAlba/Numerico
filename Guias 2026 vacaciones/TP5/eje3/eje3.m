...
x1 = linspace(-1,1,21)';
y1 = f(x1);
[f1,df1,ddf1]=funcion_spline(x1,y1);  %spline cubica
...
i = (0:1:20)';
y2 = f(x1,i);
[f2,df2,ddf2]=funcion_spline(x1,y2);  %spline cubica
...
ylabel('Funcion (f(x))')
title('Métodos de Interpolación')
plot(xx1,f2(xx1),'r-','linewidth',6);
plot(xx1,polyval(p,xx1),'b-','linewidth',5);
%{
  =============================================================================
  CONCLUSIONES DEL EJERCICIO 3: ANÁLISIS DE RESULTADOS
  =============================================================================
