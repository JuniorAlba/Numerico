...
% [x, w] = gauss_xw(n)
%
% Genera las abscisas y pesos para la Cuadratura de Gauss-Legendre 
...
%
% SALIDAS:
%   x: abscisas (nodos) de la cuadratura.
%   w: pesos de la cuadratura.
%
% OBJETIVO:
%   Optimizar la elección de los puntos para que la fórmula sea exacta 
%   para polinomios del mayor grado posible (2n-1).
  x = zeros(n,1);
  w = x;
  m = (n+1)/2;
  for ii=1:m
