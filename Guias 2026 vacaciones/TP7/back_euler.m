...
%
% SALIDAS:
%   t     - Vector columna con los tiempos t_i.
%   y     - Vector con la solución aproximada y(t_i).
%
% OBJETIVO:
%   Resuelve el PVI usando el Método de Euler Hacia Atrás (Implícito) O(h).
%   Al ser implícito, utiliza el Método de Newton-Raphson internamente
%   para encontrar la raíz en cada paso de tiempo. Este método es incondicionalmente estable.
    tol = 1e-9;
    kmax=100;
    h = (b-a)/N;
    t = linspace(a,b,N+1)';
