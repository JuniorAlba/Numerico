...
%
% OBJETIVO:
%   Aproximar la solución del PVI utilizando el Método de Runge-Kutta de orden 2 (Método de Heun),
%   que realiza una predicción (Euler) y una corrección en cada paso. Orden empírico O(h^2).
